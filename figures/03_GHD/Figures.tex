...
\begin{tikzpicture}
            ...
            decoration={
                ...
                mark=at position 0.5 with {
                    \node[
						...
						scale = 1.0,
						font = \fontsize{20}{5}\selectfont \bfseries 
                    ] (my node) {\color{\colorThree}  $ \ell \gg \ell_c $};
	...
	\begin{scope}[shift={(0,-9)}]
		...
		(-0.5, 0) edge[{Computer Modern Rightarrow[line cap=round]}-{Computer Modern Rightarrow[line cap=round]}] node[pos = 0.5 , right , shift = {(-0.25 , 0.5 )} , color = \colorOne , scale = 1.5 , font = \fontsize{15}{5}\selectfont \bfseries ]{ \color{\colorThree} $\ell_c$ } (0.5, 0)
